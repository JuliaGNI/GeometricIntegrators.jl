...
# function get_initial_conditions!(sol::SolutionODE{AT,TT}, asol::AtomicSolutionODE{DT,TT,AT}, k, n = 1) where {DT,TT,AT <:AbstractArray{DT}} # TODO
# function get_initial_conditions!(asol::AtomicSolutionODE, sol::SolutionODE, n = 1)
#     copy!(asol, sol[0])
# end

# function get_initial_conditions!(sol::SolutionODE{DT}, q::DT, k, n = 1) where {DT} # TODO
# function get_initial_conditions!(q::AT, sol::SolutionODE, n = 1) where {AT <: AbstractArray}
#     get_solution!(q, sol, n - 1)
# end

# function get_initial_conditions(sol::SolutionODE, n = 1)
#     get_solution(sol, n - 1)
# end

# function set_solution!(sol::SolutionODE, t, q, n)
#     sol[n] = (t = t, q = q)
# end

# function set_solution!(sol::SolutionODE{AT,TT}, asol::AtomicSolutionODE{DT,TT,AT}, n, k = 1) where {DT,TT,AT<:AbstractArray{DT}}
# function Base.setindex!(sol::SolutionODE, asol::AtomicSolutionODE, n)
#     sol[n] = (t = asol.t, q = asol.q)
# end
...
# function get_solution!(sol::SolutionODE{AT}, q::AT, n, k = 1) where {AT} # TODO
# function get_solution!(sol::SolutionODE, q::AT, n) where {AT <: AbstractArray}
#     q .= sol.q[n]
# end

# function get_solution(sol::SolutionODE, n)
#     (t = sol.t[n], q = sol.q[n])
# end
