...
# function get_solution!(sol::SolutionPODE{AT}, q::AT, p::AT, n, k = 1) where {AT} # TODO
# function get_solution!(sol::SolutionPODE, q, p, n, k = 1)
#     q .= sol.q[n]
#     p .= sol.p[n]
# end

# function get_solution(sol::SolutionPODE{AT,TT}, n, k = 1) where {AT,TT} # TODO
# function get_solution(sol::SolutionPODE, n, k = 1)
#     @assert k == 1
#     (sol.t[n], sol.q[n], sol.p[n])
# end

# function Base.setindex!(sol::SolutionPODE, asol::AtomicSolutionPODE, n)
#     sol[n] = (t = asol.t, q = asol.q, p = asol.p)
# end
