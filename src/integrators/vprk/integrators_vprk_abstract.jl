...
function update_params!(params::AbstractParametersVPRK, sol::AtomisticSolutionPODE)
...
function update_solution!(int::AbstractIntegratorVPRK{DT,TT}, sol::AtomisticSolutionPODE{DT,TT}) where {DT,TT}
...
function project_solution!(int::AbstractIntegratorVPRK{DT,TT}, sol::AtomisticSolutionPODE{DT,TT}, R::Vector{TT}) where {DT,TT}
    update_solution!(sol.q, sol.q̃, int.cache.U, R, timestep(int))
    update_solution!(sol.p, sol.p̃, int.cache.G, R, timestep(int))
end

function project_solution!(int::AbstractIntegratorVPRK{DT,TT}, sol::AtomisticSolutionPODE{DT,TT}, RU::Vector{TT}, RG::Vector{TT}) where {DT,TT}
    update_solution!(sol.q, sol.q̃, int.cache.U, RU, timestep(int))
    update_solution!(sol.p, sol.p̃, int.cache.G, RG, timestep(int))
end

function initialize!(int::AbstractIntegratorVPRK{DT}, sol::AtomisticSolutionPODE{DT,TT}) where {DT,TT}
