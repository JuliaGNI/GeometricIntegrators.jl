...
function initialize!(int::IntegratorDVIA, sol::AtomicSolutionPODE)
...
function update_params!(int::IntegratorDVIA, sol::AtomicSolutionPODE)
...
function initial_guess!(int::IntegratorDVIA{DT,TT,D}, sol::AtomicSolutionPODE{DT,TT},
...
function integrate_step!(int::IntegratorDVIA{DT,TT}, sol::AtomicSolutionPODE{DT,TT},
