...
function update_params!(int::IntegratorIPRK, sol::SolutionStepPODE)
...
function initial_guess!(int::IntegratorIPRK{DT}, sol::SolutionStepPODE{DT},
...
function integrate_step!(int::IntegratorIPRK{DT,TT}, sol::SolutionStepPODE{DT,TT},
