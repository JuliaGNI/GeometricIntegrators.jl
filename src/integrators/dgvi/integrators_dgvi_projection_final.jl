...
function IntegratorCache(params::ParametersDGVIP1{DT,TT,D,S,R}; kwargs...) where {DT,TT,D,S,R}
...
struct IntegratorDGVIP1{DT, TT, D, S, R,
    ...
    function IntegratorDGVIP1(basis::BT, quadrature::Quadrature{TT,R}, params::ParametersDGVIP1{DT,TT,D,S},
    ...
    function IntegratorDGVIP1{DT,D}(equations::NamedTuple, basis::Basis{TT,P}, quadrature::Quadrature{TT,R}, Δt::TT;
    ...
    function IntegratorDGVIP1(equation::IODE{DT,TT}, basis::Basis{TT}, quadrature::Quadrature{TT}, Δt::TT; kwargs...) where {DT,TT}
        IntegratorDGVIP1{DT, ndims(equation)}(get_function_tuple(equation), basis, quadrature, Δt; kwargs...)
    end
end
...
function initial_guess!(int::IntegratorDGVIP1{DT,TT, D, S, R}, sol::AtomicSolutionPODE{DT,TT},
...
function integrate_step!(int::IntegratorDGVIP1{DT,TT}, sol::AtomicSolutionPODE{DT,TT},
