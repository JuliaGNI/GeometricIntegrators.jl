...
function residual!(x::Vector{ST}, b::Vector{ST}, params::ParametersDGVIEXP{DT,TT,D,S,R},
...
function components!(x, cache::IntegratorCacheDGVI{ST,D,S}, params::ParametersDGVIEXP{DT,TT,D,S}) where {ST,DT,TT,D,S}
    # copy x to X
    for i in 1:S
        for k in 1:D
