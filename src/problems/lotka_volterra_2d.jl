...
function lotka_volterra_2d_ode(; x₀=[2., 1.], a1=-2, b1=+1, a2=+1, b2=-1)
    function lotka_volterra_2d_ode_f(t, x, f)
       lotka_volterra_2d_ode_f_params(t, x, f, a1, b1, a2, b2)
    end
    ODE(lotka_volterra_2d_ode_f_params, x₀)
end
...
function lotka_volterra_2d_idae(q₀=[1., 1.], p₀=[1. + log(1.), 1.], λ₀ = [0.0, 0.0])
    IDAE(lotka_volterra_2d_iode_f, lotka_volterra_2d_iode_p, lotka_volterra_2d_idae_u, lotka_volterra_2d_idae_g, lotka_volterra_2d_idae_ϕ, q₀, p₀, λ₀)
end
