...
const IntegratorSymmetricProjection{DT,TT} = GeometricIntegrator{<:EquationProblem{DT,TT}, <:ProjectedMethod{<:SymmetricProjection}}
...
function integrate_step!(int::GeometricIntegrator{<:EquationProblem, <:ProjectedMethod{<:SymmetricProjection}})
