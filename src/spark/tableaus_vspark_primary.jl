...
"""
function TableauVSPARKInternalProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
"""
function TableauVSPARKMidpointProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
    s = q.s
...
function TableauVSPARKLobattoIIIAIIIBpMidpoint(s)
    TableauVSPARKMidpointProjection(
        Symbol("LobattoIIIAIIIB($s)pMidpoint"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApMidpoint(s)
    TableauVSPARKMidpointProjection(
        Symbol("LobattoIIIBIIIA($s)pMidpoint"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
"""
function TableauVSPARKModifiedMidpointProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
    s = q.s
...
function TableauVSPARKLobattoIIIAIIIBpModifiedMidpoint(s)
    TableauVSPARKModifiedMidpointProjection(
        Symbol("LobattoIIIAIIIB($s)pModifiedMidpoint"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApModifiedMidpoint(s)
    TableauVSPARKModifiedMidpointProjection(
        Symbol("LobattoIIIBIIIA($s)pModifiedMidpoint"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
"""
function TableauVSPARKSymmetricProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
function TableauVSPARKLobattoIIIAIIIBpSymmetric(s)
    TableauVSPARKSymmetricProjection(
        Symbol("LobattoIIIAIIIB($s)pSymmetric"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApSymmetric(s)
    TableauVSPARKSymmetricProjection(
        Symbol("LobattoIIIBIIIA($s)pSymmetric"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
"""
function TableauVSPARKLobattoIIIAIIIBProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
function TableauVSPARKLobattoIIIAIIIBpLobattoIIIAIIIB(s)
    TableauVSPARKLobattoIIIAIIIBProjection(
        Symbol("LobattoIIIAIIIB($s)pLobattoIIIAIIIB(2)"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApLobattoIIIAIIIB(s)
    TableauVSPARKLobattoIIIAIIIBProjection(
        Symbol("LobattoIIIBIIIA($s)pLobattoIIIAIIIB(2)"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
"""
function TableauVSPARKLobattoIIIBIIIAProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
function TableauVSPARKLobattoIIIAIIIBpLobattoIIIBIIIA(s)
    TableauVSPARKLobattoIIIBIIIAProjection(
        Symbol("LobattoIIIAIIIB($s)pLobattoIIIBIIIA(2)"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApLobattoIIIBIIIA(s)
    TableauVSPARKLobattoIIIBIIIAProjection(
        Symbol("LobattoIIIBIIIA($s)pLobattoIIIBIIIA(2)"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
"""
function TableauVSPARKModifiedLobattoIIIAIIIBProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
function TableauVSPARKLobattoIIIAIIIBpModifiedLobattoIIIAIIIB(s)
    TableauVSPARKModifiedLobattoIIIAIIIBProjection(
        Symbol("LobattoIIIAIIIB($s)pModifiedLobattoIIIAIIIB(2)"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApModifiedLobattoIIIAIIIB(s)
    TableauVSPARKModifiedLobattoIIIAIIIBProjection(
        Symbol("LobattoIIIBIIIA($s)pModifiedLobattoIIIAIIIB(2)"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKGLRKpModifiedLobattoIIIAIIIB(s)
    glrk = TableauGauss(s)
    TableauVSPARKModifiedLobattoIIIAIIIBProjection(
        Symbol("GLRK($s)pModifiedLobattoIIIAIIIB(2)"), glrk, glrk; R∞ = (-1)^s)
end
...
"""
function TableauVSPARKModifiedLobattoIIIBIIIAProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = 1) where {T}
    @assert q.s == p.s
...
function TableauVSPARKLobattoIIIAIIIBpModifiedLobattoIIIBIIIA(s)
    TableauVSPARKModifiedLobattoIIIBIIIAProjection(
        Symbol("LobattoIIIAIIIB($s)pModifiedLobattoIIIBIIIA(2)"), TableauLobattoIIIA(s),
        TableauLobattoIIIB(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKLobattoIIIBIIIApModifiedLobattoIIIBIIIA(s)
    TableauVSPARKModifiedLobattoIIIBIIIAProjection(
        Symbol("LobattoIIIBIIIA($s)pModifiedLobattoIIIBIIIA(2)"), TableauLobattoIIIB(s),
        TableauLobattoIIIA(s), lobatto_nullvector(s); R∞ = (-1)^(s+1))
end
...
function TableauVSPARKGLRKpModifiedLobattoIIIBIIIA(s)
    glrk = TableauGauss(s)
    TableauVSPARKModifiedLobattoIIIBIIIAProjection(
        Symbol("GLRK($s)pModifiedLobattoIIIBIIIA(2)"), glrk, glrk; R∞ = (-1)^s)
end

function TableauVSPARKSymplecticProjection(
        name, q::Tableau{T}, p::Tableau{T}, d = nothing; R∞ = +1) where {T}
