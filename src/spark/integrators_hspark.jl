...
function solversize(method::Union{HSPARK, SPARKMethod}, problem::AbstractProblemPDAE)
...
```
"""
const IntegratorHSPARK{DT, TT} = GeometricIntegrator{
    <:HSPARK, <:Union{PDAEProblem{DT, TT}, HDAEProblem{DT, TT}}}
...
function components!(x::AbstractVector{ST}, sol, params,
        int::GeometricIntegrator{<:HSPARK, <:Union{PDAEProblem, HDAEProblem}}) where {ST}
