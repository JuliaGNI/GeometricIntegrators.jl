...
struct AbstractTableauSPARK{IT, DT <: Number, DVT} <: AbstractTableau{DT}
    ...
    function AbstractTableauSPARK{IT, DT}(
            name::Symbol, o::Int, s::Int, r::Int, ρ::Int, q, p, q̃, p̃, λ, ω, δ,
            d::DVT = nothing) where {IT, DT, DVT <: Union{AbstractVector, Nothing}}
...
function Base.:(==)(tab1::AbstractTableauSPARK, tab2::AbstractTableauSPARK)
    (tab1.o == tab2.o
     && tab1.s == tab2.s
     && tab1.r == tab2.r
     && tab1.ρ == tab2.ρ
...
function Base.isapprox(tab1::AbstractTableauSPARK, tab2::AbstractTableauSPARK; kwargs...)
    (
        tab1.o == tab2.o
        && tab1.s == tab2.s
        && tab1.r == tab2.r
