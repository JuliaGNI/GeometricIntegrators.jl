...
function TableauSymplecticProjection(
...
function TableauLobattoIIIAIIIBpSymplectic(s)
    TableauSymplecticProjection(
        Symbol("LobattoIIIAIIIB($s)pSymplectic"), TableauLobattoIIIA(s),
...
function TableauLobattoIIIBIIIApSymplectic(s)
    TableauSymplecticProjection(
        Symbol("LobattoIIIBIIIA($s)pSymplectic"), TableauLobattoIIIB(s),
