...
function TableauHSPARKSymmetricProjection(
...
function TableauHSPARKLobattoIIIBIIIApSymmetric(s)
    TableauHSPARKSymmetricProjection(Symbol("HSPARKLobattoIIIBIIIA($s)pSymmetric"),
        TableauLobattoIIIB(s), TableauLobattoIIIB̄(s))
end
