...
@testset "$(rpad("ODE Solution",80))" begin
    ...
    sol = Solution(similar(ode, tspan = 2 .* timespan(ode)), 2)
    @test ntime(sol) == 20
    @test nstore(sol) == 10
...
@testset "$(rpad("PODE Solution",80))" begin
    ...
    # test step and nstore parameters
    sol = Solution(similar(pode, tspan = 2 .* timespan(pode)), 2)
    @test ntime(sol) == 20
    @test nstore(sol) == 10

    sol = Solution(similar(pode, tspan = 2 .* timespan(pode)), 10)
    @test ntime(sol) == 20
    @test nstore(sol) == 2
end
...
@testset "$(rpad("DAE Solution",80))" begin
    ...
    # test step and nstore parameters
    sol = Solution(similar(dae, tspan = 2 .* timespan(dae)), 2)
    @test ntime(sol) == 20
    @test nstore(sol) == 10

    sol = Solution(similar(dae, tspan = 2 .* timespan(dae)), 10)
    @test ntime(sol) == 20
    @test nstore(sol) == 2
end
...
@testset "$(rpad("PDAE Solution",80))" begin
    ...
    # test step and nstore parameters
    sol = Solution(similar(pdae, tspan = 2 .* timespan(pdae)), 2)
    @test ntime(sol) == 20
    @test nstore(sol) == 10
