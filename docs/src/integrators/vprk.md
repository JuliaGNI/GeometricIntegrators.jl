...
| [`VPRKpTableau`](@ref)      | Gauss-Legendre VPRK integrator with projection in the tableau of the Runge-Kutta method (*experimental*) |
...
In GeometricIntegrators, these vectors can be obtained via the function [`lobatto_nullvector`](@ref) from [RungeKutta.jl](https://github.com/JuliaGNI/RungeKutta.jl).
